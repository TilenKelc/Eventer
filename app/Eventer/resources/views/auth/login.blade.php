...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Že imate uporabniški račun?') }}</div>
    ...
    <div class="row justify-content-center">
      <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-header">{{ __('Prvič pri nas?') }}</div>

            <div class="card-body">
              <div class="form-group row mb-0">
                  <div class="col-md-8 offset-md-4">
                      <a href="/register" class="btn custom-submit-btn link">
                          {{ __('Registrirajte se') }}
                      </a>
